    ...
    return (
        <section id='faq' className={`${darkMode ? 'dark bg-black' : 'light bg-white'} w-full lg:px-20 px-10 lg:py-20 py-10 grid lg:grid-cols-2 grid-cols-1 justify-center items-start gap-14`}>
            <div id='left' className='flex flex-col justify-center items-center gap-12'>
                <h1 data-aos="zoom-in" data-aos-delay="200" className='text-6xl text-black font-bold text-center dark:text-white'>Frequently Asked Questions</h1>
            ...
            <div id='right' className='grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-4'>
                <img data-aos="zoom-in" data-aos-delay="400" src={faqimg1} alt="" className='w-[400px] h-[400px] rounded-xl' />
                <img data-aos="zoom-in" data-aos-delay="600" src={faqimg2} alt="" className='w-[400px] h-[400px] rounded-xl' />
                <img data-aos="zoom-in" data-aos-delay="800" src={faqimg3} alt="" className='w-[400px] h-[400px] rounded-xl' />
                <img data-aos="zoom-in" data-aos-delay="1000" src={faqimg4} alt="" className='w-[400px] h-[400px] rounded-xl' />
            </div>
        </section>
    )
}
